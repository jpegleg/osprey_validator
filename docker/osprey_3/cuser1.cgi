...
blobjwt=$(curl http://127.0.0.1:5600/login -d '{"identity": "observiceadmin@authorized.domain.98_map", "service_id": "3ec85f59dce67fc936d7f1e63466aea3b6c"}' -H 'Content-Type: application/json'  | cut -c14-616 | cut -d '|' -f2)
